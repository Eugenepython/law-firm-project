// src/components/Lawfirmcomponents/newCases/CreateCase.js
...
const CreateCase = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      console.log('Dispatching addCase with:', data.createCase);
      
      dispatch(addCase(data.createCase));
      
      // Log after dispatching
      console.log('Redux state updated, navigating to ViewCases');
  ...
  return (
    <div className="container">
      ...
      <form onSubmit={handleSubmit}>
        ...
        <button className="the-button" type="submit" disabled={loading}>
